 ...
 * @param[in,out] dev  Pointer to driver handle (SPI handle & config must be
 * set)
 ...
 * @retval  0 on success, negative on error
 */
int LSM6DSO32_ReadReg(LSM6DSO32_Handle_t *dev, uint8_t reg, uint8_t *data,
                      uint16_t len);
 ...
 * @retval  0 on success, negative on error
 */
int LSM6DSO32_WriteReg(LSM6DSO32_Handle_t *dev, uint8_t reg,

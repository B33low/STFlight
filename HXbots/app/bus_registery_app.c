...
extern StateAny g_state_gyro_setpoint;

static const BusItem g_items[] = {{.id = ID_IMU_RAW,
                                   .kind = BUS_KIND_STREAM,
                                   .ptr = &g_stream_imu_raw.base,
                                   .name = "IMU_RAW"},
                                  {.id = ID_IMU_CONV,
                                   .kind = BUS_KIND_PARAM,
                                   .ptr = &g_param_imu_conv,
                                   .name = "IMU_CONV_META"},
                                  {.id = ID_ATT_STATE,
                                   .kind = BUS_KIND_STATE,
                                   .ptr = &g_state_attitude,
                                   .name = "ATTITUDE"},
                                  {.id = ID_ALT_STATE,
                                   .kind = BUS_KIND_STATE,
                                   .ptr = &g_state_altitude,
                                   .name = "ALTITUDE"},
                                  {.id = ID_GYRO_SETPOINT_STATE,
                                   .kind = BUS_KIND_STATE,
                                   .ptr = &g_state_gyro_setpoint,
                                   .name = "GYRO_SETPOINT"}};

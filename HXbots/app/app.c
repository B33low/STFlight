...
StateGyroSetpoint g_state_gyro_setpoint;
...
void app_init(void)
{
    ...
    // gyro state point data services
    // state_any_init(&g_state_gyro_setpoint, &g_gyro_setpoint,
    //                sizeof(GyroSetpointState));
    state_gyro_setpoint_init(&g_state_gyro_setpoint);
...
void app_loop(void)
{
    ...
    { // 20 Hz
        ...
        bus_serialize_latest(5, BUS_KIND_STATE, mcu_uart_write, &huart2);
    }
